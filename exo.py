...
print("\n-----Question 18-----\n")
# 1. Conversion des unités (en kg et en m)
MJUP_KG = 1.898e27       # Masse de Jupiter en kg
RJUP_M = 7.1492e7        # Rayon de Jupiter en mètres

# 2. Création d'une copie de df pour éviter conflits
df_density = df.copy()

# 3. Vérification que les deux colonnes nécessaires ne sont pas nulles
